...
WebUI.callTestCase(findTestCase('Liverpool-Demo/AddAddress'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.verifyTextPresent(GlobalVariable.RandomName, false)
...
WebUI.sendKeys(findTestObject('DemoObjects/myAccount/PaternoName_AM'), RandomName)
...
WebUI.verifyTextPresent(RandomName, false)
